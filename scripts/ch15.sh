...
echo -e "pg 507"
echo -e "\n"
curl "http://localhost:8983/solr/salestax/select?q=*:*&userSalesTax=0.07&fl=id,basePrice,product(basePrice,%20sum(1,%20$userSalesTax))"
java -jar $SOLR_IN_ACTION/solr-in-action.jar listing 15.1
echo -e "\n"
echo -e "pg 508"
echo -e "\n"
curl "http://localhost:8983/solr/salestax/select?q=*:*&userSalesTax=0.07&sort=product(basePrice,%20sum(1,%20$userSalesTax))%20asc,%20score%20desc"
